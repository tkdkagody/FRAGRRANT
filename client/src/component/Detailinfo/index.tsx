...
function DetailInfo () {
        ...
        const [listInfo, setListInfo] = useState<ListProps>(
            ...
            scent : ["Top: 베르가못","Middle: 민트", "Bottom: 화이트머스크"],  //객체형태로 바꾸어야함, 타입 알아보기
        ...
        if(listInfo.month === "2월"){
            ...
            listInfo.season = "https://images.velog.io/images/beablessing/post/a9c75608-efc8-49e9-a5e7-87c283091a53/Screenshot%20from%202021-11-27%2003-00-20.png" ;
        }
    ...
    return (
        <Section>
            <Box>
                    ...
                    <Scent>{listInfo.scent.map((el)=> (<span>{el}</span>))}</Scent>
